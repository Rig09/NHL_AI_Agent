...
with st.expander("More about this chatbot"):
    st.info("""This chatbot leverages LangChain and OpenAI's GPT-4o model to interact with user queries for information about the NHL. To use the chatbot simply type a question into the bar or click on one of the sample questions\n
