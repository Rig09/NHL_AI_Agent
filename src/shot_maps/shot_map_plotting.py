...
def extract_shot_data(db, api_key, llm, conditions, season_lower_bound, season_upper_bound, season_type, situation, shot_result):
    """
...
def goal_map_scatter_get(db, api_key, llm, conditions, season_lower_bound, season_upper_bound, season_type, situation):
    ...
    player_shots = extract_shot_data(db, api_key, llm, conditions, season_lower_bound, season_upper_bound, season_type, situation, shot_result="GOAL")
...
def shot_map_scatter_get(db, api_key, llm, conditions, season_lower_bound, season_upper_bound, season_type, situation):
    """
    ...
    player_shots = extract_shot_data(db, api_key, llm, conditions, season_lower_bound, season_upper_bound, season_type, situation, shot_result="SOG_OR_GOAL")
...
def heat_map_get(db, api_key, llm, conditions, all_shots, season_lower_bound, season_upper_bound, season_type, situation):
    """
